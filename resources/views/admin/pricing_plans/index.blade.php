...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Pricing Plans</h1>
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <a href="{{ route('pricing-plans.createOrEdit') }}" class="btn btn-primary btn-sm">
                <i class="fas fa-plus me-1"></i> Add Pricing Plan
            </a>
        </div>
    </div>
</div>
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container-fluid mt-5">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="search_text" placeholder="Search pricing plans...">
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="d-flex flex-column w-table rounded mt-5 bg-white p-5 container-fluid">
            {!! $dataTable->table(['class' => 'table table-hover border-0 w-100 responsive_view_table', 'id' => 'pricing-plans-table']) !!}
        </div>
    </div>
    <!--end::Post-->
</div>
...
$(document).ready(function () {
    ...
    // Filters
    $('#pricing-plans-table').on('preXhr.dt', function(e, settings, data) {
        data['search_text'] = $('#search_text').val();
    });

    const showTable = () => {
        window.LaravelDataTables["pricing-plans-table"].draw(true);
    }
    ...
    $('#pricing-plans-table').on('click', '.delete-company', function () {
        const id = $(this).data('id');
        const url = "{{ route('pricing-plans.destroy', ':id') }}";
        ...
        confirmDelete(id, url, function() {
            window.LaravelDataTables["pricing-plans-table"].ajax.reload(null, false);
